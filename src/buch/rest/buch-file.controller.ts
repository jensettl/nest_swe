...
@ApiTags('REST-API')
export class BuchFileController {
    readonly #service: BuchFileService;

    readonly #logger = getLogger(BuchFileController.name);

    constructor(service: BuchFileService) {
    ...
    #handleDownloadError(err: BuchNotExists | DownloadError, res: Response) {
